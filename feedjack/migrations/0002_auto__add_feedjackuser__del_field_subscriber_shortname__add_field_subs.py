...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedjackUser'
        db.create_table(u'feedjack_feedjackuser', (
            (u'user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedjack.Site'])),
        ))
        db.send_create_signal(u'feedjack', ['FeedjackUser'])

        # Deleting field 'Subscriber.shortname'
        db.delete_column(u'feedjack_subscriber', 'shortname')

        # Adding field 'Subscriber.slug'
        db.add_column(u'feedjack_subscriber', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=50, populate_from='name'),
                      keep_default=False)

        # Deleting field 'Feed.shortname'
        db.delete_column(u'feedjack_feed', 'shortname')

        # Adding field 'Feed.slug'
        db.add_column(u'feedjack_feed', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=50, populate_from='name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FeedjackUser'
        db.delete_table(u'feedjack_feedjackuser')

        # Adding field 'Subscriber.shortname'
        db.add_column(u'feedjack_subscriber', 'shortname',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Subscriber.slug'
        db.delete_column(u'feedjack_subscriber', 'slug')


        # User chose to not deal with backwards NULL issues for 'Feed.shortname'
        raise RuntimeError("Cannot reverse this migration. 'Feed.shortname' and its values cannot be restored.")
        # Deleting field 'Feed.slug'
        db.delete_column(u'feedjack_feed', 'slug')
    ...
    models = {
        ...
        u'feedjack.feedjackuser': {
            'Meta': {'object_name': 'FeedjackUser', '_ormbases': [u'auth.User']},
