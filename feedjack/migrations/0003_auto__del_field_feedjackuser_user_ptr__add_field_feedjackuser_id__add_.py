...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeedjackUser.user_ptr'
        db.delete_column(u'feedjack_feedjackuser', u'user_ptr_id')
        ...
        db.add_column(u'feedjack_feedjackuser', 'user',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FeedjackUser.user_ptr'
        raise RuntimeError("Cannot reverse this migration. 'FeedjackUser.user_ptr' and its values cannot be restored.")
        # Deleting field 'FeedjackUser.id'
        db.delete_column(u'feedjack_feedjackuser', u'id')

        # Deleting field 'FeedjackUser.user'
        db.delete_column(u'feedjack_feedjackuser', 'user_id')
