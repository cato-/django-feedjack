...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feedjack_link', 'link', self.gf('django.db.models.fields.URLField')(max_length=2000))

        # Changing field 'Post.comments'
        db.alter_column(u'feedjack_post', 'comments', self.gf('django.db.models.fields.URLField')(max_length=2000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Link.link'
        db.alter_column(u'feedjack_link', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Post.comments'
        db.alter_column(u'feedjack_post', 'comments', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Post.link'
        db.alter_column(u'feedjack_post', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Feed.feed_url'
        db.alter_column(u'feedjack_feed', 'feed_url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True))

        # Changing field 'Feed.link'
        db.alter_column(u'feedjack_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'feedjack.feed': {
            ...
            'feed_url': ('django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '2000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': "'name'"}),
            'tagline': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        u'feedjack.feedjackuser': {
            'Meta': {'object_name': 'FeedjackUser'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'feedjack.post': {
            ...
            'comments': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'blank': 'True'}),
